// spec: specs/tc-45-ci-dry-run-user-can-submit-a-ticket-and-see-it-listed.md
// seed: tests/seed.spec.ts

import { test, expect } from '@playwright/test';
import { createTestData } from '../../../helpers/testData';

test.describe('CI dry-run', () => {
  test('TC-45: CI dry-run: user can submit a ticket and see it listed', async ({ page }) => {
    ...
    await test.step('Select category Software and priority High', async () => {
      ...
      // FRAGILE: positional combobox lookup scoped to the modal dialog.
